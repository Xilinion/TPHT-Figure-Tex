...
\begin{figure*}[h]
    ...
    \begin{subfigure}[b]{0.35\linewidth}
        \centering
        \begin{tikzpicture}
            \begin{axis}[spaceeff compact axis with ylabel, legend to name={spaceeff-legend-compact}, legend entries={\htone, \httwo, \htb, \htg, \htcp, \htcs, \htlp, \htls}, legend cell align=left, legend style={draw=none, legend columns=4, /tikz/every even column/.append style={column sep=0.1cm}}]
