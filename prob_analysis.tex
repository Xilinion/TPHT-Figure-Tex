...
\begin{minipage}[t]{0.48\linewidth}
    ...
    \captionof{figure}{Maximum load factor supported by power-of-two dereference tables across bin sizes, as described in \S\ref{subsec:tpimpl}.}
...
\begin{minipage}[t]{0.48\linewidth}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addlegendentry{Poisson Approximation ($\lambda=1$)}
    ...
    \captionof{figure}{Bin occupancy distribution comparing with smoothed Poisson approximation ($\lambda=1$).}
