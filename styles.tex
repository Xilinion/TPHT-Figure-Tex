...
\definecolor{exp7}{RGB}{102, 194, 165}    % teal - backup1
\definecolor{exp8}{RGB}{231, 138, 195}    % pink - backup2
...
\pgfplotsset{
    ...
    BackupLineStyleOne/.style={color=exp7, mark=otimes, mark size=2.8pt, thick, smooth, mark options={solid}},
    BackupLineStyleTwo/.style={color=exp8, mark=x, mark size=2.8pt, thick, smooth, mark options={solid}},
    % Macro-based aliases
