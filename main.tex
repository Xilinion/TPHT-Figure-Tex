...
\pgfplotstableread[col sep=comma, sci]{../results/csv/occupancy_experimental_box.csv}{\occbox}
\pgfplotstableread[col sep=comma, sci]{../results/csv/occupancy_poisson.csv}{\occpois}
\pgfplotstableread[col sep=comma, sci]{../results/csv/data_size_scaling_results.csv}{\datasizedata}
