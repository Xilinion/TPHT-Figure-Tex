\begin{figure}[h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xtick={0,1,2,3},
                xticklabels={Insert, \hspace*{-5pt}Deletion, \hspace*{-12pt}Positive Query, Negative Query},
                axis lines=box,
                tick align=inside,
    ...
    \caption{Throughput on L1-sized table (2047 entries) across operations.}\label{fig:small_table_throughput}
\end{figure}
