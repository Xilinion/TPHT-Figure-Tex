\begin{figure}[h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xtick={0,1,2,3},
                xticklabels={Insert, \hspace*{-7pt}Deletion, \hspace*{-14pt}Positive Query, \hspace*{3pt}Negative Query},
                axis lines=box,
                tick align=inside,
    ...
    \caption{Throughput on L1-sized table (2047 entries).}\label{fig:small_table_throughput}
\end{figure}
