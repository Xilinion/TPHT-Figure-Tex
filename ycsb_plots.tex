\begin{figure*}[h]
    \centering
    \pgfplotslegendfromname{throughput-legend-horizontal}\vspace{-1em}
    ...
    \caption{Performance of hash tables on YCSB workloads with 16 threads. (Throughput is Million ops/second).}
