...
% Local axis-label/tick shifts for this figure only
\pgfplotsset{
  data size local shifts/.style={
    xticklabel style={yshift=-1pt},
    yticklabel style={xshift=-1pt},
    xlabel style={yshift=-1pt},
    ylabel style={yshift=4pt, xshift=-5pt}
  }
}
...
\begin{figure*}[h]
  \centering
  {\pgfplotslegendfromname{spaceeff-legend}\vspace{-0.8em}}
  % Case 1
  \begin{subfigure}[b]{0.27\textwidth}
    ...
    \begin{tikzpicture}
      \begin{axis}[
          ...
          xmax=4.5,
          xtick={0,1,2,3,4},
          xticklabels={{\color{blue}1/32},4,32,256,2048},
          x filter/.expression={
            (x < 100000 ? 0 :
            (x < 1000000 ? 1 :
            (x < 10000000 ? 2 :
