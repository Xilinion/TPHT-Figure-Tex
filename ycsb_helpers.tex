...
% Special command for creating horizontal legend for standard plots
\newcommand{\generateHorizontalLegend}{%
\begin{tikzpicture}
\begin{axis}[
    hide axis,
    width=10cm,
...
\addlegendimage{ybar,CuckooStyle}
\addlegendimage{ybar,IcebergStyle}
\addlegendimage{ybar,JunctionStyle}
\addlegendimage{ybar,TPHTStyle}
\addlegendimage{ybar,BlastStyle}
\end{axis}
\end{tikzpicture}%
}
...
% Special command for creating horizontal legend for resizing plots
\newcommand{\generateHorizontalLegendResizing}{%
\begin{tikzpicture}
\begin{axis}[
    width=10cm,
    height=10cm,
    ...
    legend cell align = left,
    legend style={draw=none, legend columns=5, /tikz/every even column/.append style={column sep=0.5cm}},
    legend to name={throughput-legend-horizontal-resizing}
]
\addlegendimage{ybar,CuckooStyle}
\addlegendimage{ybar,IcebergStyle}
\addlegendimage{ybar,JunctionStyle}
